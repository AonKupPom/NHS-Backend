...
type Order_rent struct {
	...
	Product_Rent string             `form:"product_rent,omitempty" json:"product_rent,omitempty" bson:"product_rent,omitempty"`
	Customer     string             `form:"customer,omitempty" json:"customer,omitempty" bson:"customer,omitempty"`
